WITH stg_fin_nota_fiscal_raw AS (
    SELECT
        ...
        CAST("numero_nf" AS STRING) AS numero_nf,
        CAST("serie_nf" AS BIGINT) AS serie_nf,
        CAST("id_pedido_erp_b" AS BIGINT) AS id_pedido_erp_b,
        {{ hash_pii(clean_cnpj('CAST("cnpj_cliente" AS STRING)')) }} AS cnpj_cliente,
        ...
        {{ hash_pii(clean_cnpj('CAST("cnpj_transportadora" AS STRING)')) }} AS cnpj_transportadora,
        CAST("nome_transportadora" AS STRING) AS nome_transportadora,
        CAST("codigo_rastreio" AS STRING) AS codigo_rastreio,
